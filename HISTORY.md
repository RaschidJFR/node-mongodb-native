...
## [8.0.0](https://github.com/RaschidJFR/node-mongodb-native/compare/v7.5.0...v8.0.0) (2026-07-15)


### ⚠ BREAKING CHANGES

* **NODE-7259:** use alphas of all supporting packages ([#4746](https://github.com/RaschidJFR/node-mongodb-native/issues/4746))
* **NODE-5510:** dont filter change stream options ([#4723](https://github.com/RaschidJFR/node-mongodb-native/issues/4723))
* **NODE-6296:** remove cursor default batch size of 1000 ([#4729](https://github.com/RaschidJFR/node-mongodb-native/issues/4729))
* **NODE-7150:** update peer dependency matrix for 3rd party peer deps ([#4720](https://github.com/RaschidJFR/node-mongodb-native/issues/4720))
* **NODE-7046:** remove AWS uri/options support ([#4689](https://github.com/RaschidJFR/node-mongodb-native/issues/4689))
* **NODE-4808:** remove support for stream() transform on cursors and change streams ([#4728](https://github.com/RaschidJFR/node-mongodb-native/issues/4728))
* **NODE-6377:** remove noResponse option ([#4724](https://github.com/RaschidJFR/node-mongodb-native/issues/4724))
* **NODE-6473:** remove MONGODB-CR auth ([#4717](https://github.com/RaschidJFR/node-mongodb-native/issues/4717))
* **NODE-5994:** Remove metadata-related properties from public driver API ([#4716](https://github.com/RaschidJFR/node-mongodb-native/issues/4716))
* **NODE-7016:** remove `beta` namespace and move resource management into driver ([#4719](https://github.com/RaschidJFR/node-mongodb-native/issues/4719))
* **NODE-4184:** don't throw on aggregate with write concern and explain ([#4718](https://github.com/RaschidJFR/node-mongodb-native/issues/4718))
* **NODE-7043, NODE-7217:** adopt mongodb-client-encryption v7 ([#4705](https://github.com/RaschidJFR/node-mongodb-native/issues/4705))
* **NODE-6065:** throw MongoRuntimeError instead of MissingDependencyError in crypto connection ([#4711](https://github.com/RaschidJFR/node-mongodb-native/issues/4711))
* **NODE-6584:** improve typing for filepaths in AutoEncryptionOptions ([#4341](https://github.com/RaschidJFR/node-mongodb-native/issues/4341))
* **NODE-6334:** rename PoolRequstedRetry to PoolRequestedRetry ([#4696](https://github.com/RaschidJFR/node-mongodb-native/issues/4696))
* **NODE-7174:** drop support for Node16 and Node18 ([#4668](https://github.com/RaschidJFR/node-mongodb-native/issues/4668))
* **NODE-7047:** use custom credential provider first after URI ([#4656](https://github.com/RaschidJFR/node-mongodb-native/issues/4656))
* **NODE-6988:** require aws sdk for aws auth ([#4659](https://github.com/RaschidJFR/node-mongodb-native/issues/4659))

### Features

* bump bson to 7.0.0-alpha.2 ([#4756](https://github.com/RaschidJFR/node-mongodb-native/issues/4756)) ([9b34953](https://github.com/RaschidJFR/node-mongodb-native/commit/9b3495359d4c87a26c33a2c2887c20d595e073e3))
* **NODE-4179:** allow secureContext in KMS TLS options ([#4578](https://github.com/RaschidJFR/node-mongodb-native/issues/4578)) ([0ea6eaa](https://github.com/RaschidJFR/node-mongodb-native/commit/0ea6eaa82d56073f1a63d4168935d63a4a4e7a61))
* **NODE-4184:** don't throw on aggregate with write concern and explain ([#4718](https://github.com/RaschidJFR/node-mongodb-native/issues/4718)) ([88e02a4](https://github.com/RaschidJFR/node-mongodb-native/commit/88e02a41eaf69da100b2beeabc67a26406d4f2b7))
* **NODE-4243:** drop collection checks ns not found ([#4742](https://github.com/RaschidJFR/node-mongodb-native/issues/4742)) ([a8d7c5f](https://github.com/RaschidJFR/node-mongodb-native/commit/a8d7c5ff6c68ad57291641b2eb14cc27d91508ae))
* **NODE-4808:** remove support for stream() transform on cursors and change streams ([#4728](https://github.com/RaschidJFR/node-mongodb-native/issues/4728)) ([1702987](https://github.com/RaschidJFR/node-mongodb-native/commit/17029879712f9af4e941203deb636af612c02c62))
* **NODE-5055:** Add databaseName property to command monitoring events ([#4586](https://github.com/RaschidJFR/node-mongodb-native/issues/4586)) ([3faf0c9](https://github.com/RaschidJFR/node-mongodb-native/commit/3faf0c967cd47b7fa6143aff914b4d2c47a584b3))
* **NODE-5393:** aws4 no longer required for AWS authentication ([#4824](https://github.com/RaschidJFR/node-mongodb-native/issues/4824)) ([0f46db8](https://github.com/RaschidJFR/node-mongodb-native/commit/0f46db8a6135178dbe2806bb1289870e8973f382))
* **NODE-5510:** dont filter change stream options ([#4723](https://github.com/RaschidJFR/node-mongodb-native/issues/4723)) ([a2daf76](https://github.com/RaschidJFR/node-mongodb-native/commit/a2daf764d0a0a0be1d60727fdbdbf99e897e60aa))
* **NODE-5545:** remove deprecated objects ([#4704](https://github.com/RaschidJFR/node-mongodb-native/issues/4704)) ([cfbada6](https://github.com/RaschidJFR/node-mongodb-native/commit/cfbada66ceb017bdb8fa1ff39257e1ab49ee9e25))
* **NODE-5672:** support standardized logging ([#4387](https://github.com/RaschidJFR/node-mongodb-native/issues/4387)) ([d1b2453](https://github.com/RaschidJFR/node-mongodb-native/commit/d1b2453daeed50cd9edd5b8a631789a36429d6b2))
* **NODE-5994:** Remove metadata-related properties from public driver API ([#4716](https://github.com/RaschidJFR/node-mongodb-native/issues/4716)) ([b59c5ce](https://github.com/RaschidJFR/node-mongodb-native/commit/b59c5ce387714e3d3fc4eed20e882f4b56597dd0))
* **NODE-6065:** throw MongoRuntimeError instead of MissingDependencyError in crypto connection ([#4711](https://github.com/RaschidJFR/node-mongodb-native/issues/4711)) ([ff229fa](https://github.com/RaschidJFR/node-mongodb-native/commit/ff229fa8e4c906f5980ee4311c0eb0d883909934))
* **NODE-6141:** allow custom aws sdk config ([#4373](https://github.com/RaschidJFR/node-mongodb-native/issues/4373)) ([3d047ed](https://github.com/RaschidJFR/node-mongodb-native/commit/3d047ed19f6bf5c06e441fdf3a9c90b05ef9c15d))
* **NODE-6245:** add keepAliveInitialDelay config ([#4510](https://github.com/RaschidJFR/node-mongodb-native/issues/4510)) ([d6c0eb3](https://github.com/RaschidJFR/node-mongodb-native/commit/d6c0eb31c21fc89856c7c2a3cab7a8b22d23c267))
* **NODE-6258:** add signal support to find and aggregate ([#4364](https://github.com/RaschidJFR/node-mongodb-native/issues/4364)) ([73def18](https://github.com/RaschidJFR/node-mongodb-native/commit/73def18d3fa0aea1fdd5122088493f948addaa42))
* **NODE-6290:** add sort support to updateOne and replaceOne ([#4515](https://github.com/RaschidJFR/node-mongodb-native/issues/4515)) ([28857b7](https://github.com/RaschidJFR/node-mongodb-native/commit/28857b79898d6a6040b7d48f3781ebc2710f0279))
* **NODE-6296:** remove cursor default batch size of 1000 ([#4729](https://github.com/RaschidJFR/node-mongodb-native/issues/4729)) ([f8a855f](https://github.com/RaschidJFR/node-mongodb-native/commit/f8a855fcfcd0a2a0314c1eee89a8cf40dddebac1))
* **NODE-6334:** rename PoolRequstedRetry to PoolRequestedRetry ([#4696](https://github.com/RaschidJFR/node-mongodb-native/issues/4696)) ([84db848](https://github.com/RaschidJFR/node-mongodb-native/commit/84db84829fb41135d19bc5216137ef84a16a1960))
* **NODE-6377:** remove noResponse option ([#4724](https://github.com/RaschidJFR/node-mongodb-native/issues/4724)) ([9e9059a](https://github.com/RaschidJFR/node-mongodb-native/commit/9e9059a82f4886748cbecc8d36045f4fef6a4015))
* **NODE-6451:** retry SRV and TXT lookup for DNS timeout errors ([#4375](https://github.com/RaschidJFR/node-mongodb-native/issues/4375)) ([fd902d3](https://github.com/RaschidJFR/node-mongodb-native/commit/fd902d31d5cb65100f1c8b6f8811886b44ba19d5))
* **NODE-6472:** findOne and find no longer keep open cursors ([#4580](https://github.com/RaschidJFR/node-mongodb-native/issues/4580)) ([be7f808](https://github.com/RaschidJFR/node-mongodb-native/commit/be7f808c3ff0d894906ec187de98e159ebb7b18d))
* **NODE-6473:** remove MONGODB-CR auth ([#4717](https://github.com/RaschidJFR/node-mongodb-native/issues/4717)) ([9a1bc65](https://github.com/RaschidJFR/node-mongodb-native/commit/9a1bc65893640f56b25049243ac94fc3dab35c8a))
* **NODE-6494:** add support for `hint` on distinct commands ([#4487](https://github.com/RaschidJFR/node-mongodb-native/issues/4487)) ([40d0e87](https://github.com/RaschidJFR/node-mongodb-native/commit/40d0e87199d75df93284a1802e54e118539f7e0e))
* **NODE-6515:** deprecate driver support for server 4.0 ([#4517](https://github.com/RaschidJFR/node-mongodb-native/issues/4517)) ([4c1a8a7](https://github.com/RaschidJFR/node-mongodb-native/commit/4c1a8a71d67cb201dbb3c7101ebf6e316e4dbc50))
* **NODE-6551:** update bson to 6.10.0 ([#4329](https://github.com/RaschidJFR/node-mongodb-native/issues/4329)) ([adb15fe](https://github.com/RaschidJFR/node-mongodb-native/commit/adb15feb4e6e4e1ce0e4e35373b0b5cef8f5a320))
* **NODE-6584:** improve typing for filepaths in AutoEncryptionOptions ([#4341](https://github.com/RaschidJFR/node-mongodb-native/issues/4341)) ([dab4c7c](https://github.com/RaschidJFR/node-mongodb-native/commit/dab4c7c8279ac1112d99d7ceca505632a45d0787))
* **NODE-6593:** add support for zstd@2.x ([#4346](https://github.com/RaschidJFR/node-mongodb-native/issues/4346)) ([ea8a33f](https://github.com/RaschidJFR/node-mongodb-native/commit/ea8a33f1c34e93dd8048ba83edca3294e474ddf5))
* **NODE-6605:** add error message when invalidating primary ([#4340](https://github.com/RaschidJFR/node-mongodb-native/issues/4340)) ([37613f1](https://github.com/RaschidJFR/node-mongodb-native/commit/37613f1a726d330967012b0c007560db1cc79bd9))
* **NODE-6633:** MongoClient.close closes active cursors ([#4372](https://github.com/RaschidJFR/node-mongodb-native/issues/4372)) ([654069f](https://github.com/RaschidJFR/node-mongodb-native/commit/654069fc1750b6c3336f1002e3d3fb18bbc1451d))
* **NODE-6676:** add support for `nsType` in change stream create events ([#4431](https://github.com/RaschidJFR/node-mongodb-native/issues/4431)) ([7800067](https://github.com/RaschidJFR/node-mongodb-native/commit/7800067ad0ea4e24e3180fe264da4951b883e08d))
* **NODE-6773:** add support for $lookup with automatic encryption ([#4427](https://github.com/RaschidJFR/node-mongodb-native/issues/4427)) ([965b21a](https://github.com/RaschidJFR/node-mongodb-native/commit/965b21a20eff38c7fe7d9036f912b31c10e5ba21))
* **NODE-6865:** deprecate transaction getters ([#4567](https://github.com/RaschidJFR/node-mongodb-native/issues/4567)) ([da46aea](https://github.com/RaschidJFR/node-mongodb-native/commit/da46aeafe857f0bbfe8935abb497ff8c92f692ca))
* **NODE-6882:** eagerly close checked out connections when client is closed ([#4499](https://github.com/RaschidJFR/node-mongodb-native/issues/4499)) ([64fdb3e](https://github.com/RaschidJFR/node-mongodb-native/commit/64fdb3ef40262d7cf321175c3ae0c4079b889624))
* **NODE-6883:** allow rawData option on time series collections ([#4642](https://github.com/RaschidJFR/node-mongodb-native/issues/4642)) ([0fa3cd4](https://github.com/RaschidJFR/node-mongodb-native/commit/0fa3cd4e82b2b0d28a10bebca1dded2aa9324708))
* **NODE-6884:** remove support for 4.0 ([#4534](https://github.com/RaschidJFR/node-mongodb-native/issues/4534)) ([6fe6ccc](https://github.com/RaschidJFR/node-mongodb-native/commit/6fe6ccc8e1a2d5cc605e7467ec7b3f83628c8095))
* **NODE-6952:** support configuring DEK cache expiration ([#4538](https://github.com/RaschidJFR/node-mongodb-native/issues/4538)) ([c529f07](https://github.com/RaschidJFR/node-mongodb-native/commit/c529f07c510f16abc158cbf33ba03230629e34d5))
* **NODE-6963:** use BSON 6.10.4 ([#4549](https://github.com/RaschidJFR/node-mongodb-native/issues/4549)) ([aee490a](https://github.com/RaschidJFR/node-mongodb-native/commit/aee490a453dc0acec7f673bdb3ca7be16d555092))
* **NODE-6988:** require aws sdk for aws auth ([#4659](https://github.com/RaschidJFR/node-mongodb-native/issues/4659)) ([b7c6750](https://github.com/RaschidJFR/node-mongodb-native/commit/b7c6750771e0a578e7f2ce6a8b9192ee7e76e8d3))
* **NODE-6991:** deprecate unintentionally public client metadata types ([#4566](https://github.com/RaschidJFR/node-mongodb-native/issues/4566)) ([ca6554b](https://github.com/RaschidJFR/node-mongodb-native/commit/ca6554b203595cd195ea80b24b1bb662d88abee9))
* **NODE-7009:** add client metadata on demand ([#4574](https://github.com/RaschidJFR/node-mongodb-native/issues/4574)) ([b9636ee](https://github.com/RaschidJFR/node-mongodb-native/commit/b9636ee3fe1daa54a65935f206f0c8fdac16ae86))
* **NODE-7016:** remove `beta` namespace and move resource management into driver ([#4719](https://github.com/RaschidJFR/node-mongodb-native/issues/4719)) ([fb2824f](https://github.com/RaschidJFR/node-mongodb-native/commit/fb2824ffd503d0b8d580df3ee51bf40cc51f53e0))
* **NODE-7020:** remove ping on connect ([#4607](https://github.com/RaschidJFR/node-mongodb-native/issues/4607)) ([3d296b7](https://github.com/RaschidJFR/node-mongodb-native/commit/3d296b7d94810c3bc29153ffc3c8795f02699dd4))
* **NODE-7043, NODE-7217:** adopt mongodb-client-encryption v7 ([#4705](https://github.com/RaschidJFR/node-mongodb-native/issues/4705)) ([3f7196e](https://github.com/RaschidJFR/node-mongodb-native/commit/3f7196eb346925f2f6c016abfd18f030de25c911))
* **NODE-7046:** remove AWS uri/options support ([#4689](https://github.com/RaschidJFR/node-mongodb-native/issues/4689)) ([d14ac3f](https://github.com/RaschidJFR/node-mongodb-native/commit/d14ac3f66a7d17ece094568355a8e5b130c9926a))
* **NODE-7047:** use custom credential provider first after URI ([#4656](https://github.com/RaschidJFR/node-mongodb-native/issues/4656)) ([2a47bbb](https://github.com/RaschidJFR/node-mongodb-native/commit/2a47bbbf03ec54509d93f925d0747378e3de80ed))
* **NODE-7053:** deprecate noResponse option ([#4589](https://github.com/RaschidJFR/node-mongodb-native/issues/4589)) ([1115319](https://github.com/RaschidJFR/node-mongodb-native/commit/1115319a0913c136c688631a0cf9f6d3dfcb2e4c))
* **NODE-7059, NODE-7008:** add support for text queries for QE string fields ([#4597](https://github.com/RaschidJFR/node-mongodb-native/issues/4597)) ([e4492f3](https://github.com/RaschidJFR/node-mongodb-native/commit/e4492f3ff260a440ab4b2cb64ca90a68f9cf6fd5))
* **NODE-7121:** prevent connection churn on backpressure errors when establishing connections ([#4800](https://github.com/RaschidJFR/node-mongodb-native/issues/4800)) ([4cb2b87](https://github.com/RaschidJFR/node-mongodb-native/commit/4cb2b87537536461dc2f5cd9f0a8a56ad193cb13))
* **NODE-7122:** exponential backoff between retries in convenient transaction API ([#4765](https://github.com/RaschidJFR/node-mongodb-native/issues/4765)) ([e70fdc9](https://github.com/RaschidJFR/node-mongodb-native/commit/e70fdc981dc2bdc0d3c12515b2eecc214d8f3ce4))
* **NODE-7125:** add db and client properties to collection and database objects ([#4640](https://github.com/RaschidJFR/node-mongodb-native/issues/4640)) ([3469f86](https://github.com/RaschidJFR/node-mongodb-native/commit/3469f86816e4b583a12de29d76b19823a3ad25ef))
* **NODE-7134:** allow hint with unacknowledged writes for delete, update and findAndModify commands ([#4647](https://github.com/RaschidJFR/node-mongodb-native/issues/4647)) ([82d6ce6](https://github.com/RaschidJFR/node-mongodb-native/commit/82d6ce6a6dbbf6d823f02c8d183fc1d45f0d1560))
* **NODE-7139:** remove pre-4.2 logic and deprecate dead code ([#4657](https://github.com/RaschidJFR/node-mongodb-native/issues/4657)) ([14303bc](https://github.com/RaschidJFR/node-mongodb-native/commit/14303bc810c1aa069d440ac3cd45bff354dc51aa))
* **NODE-7140:** deprecate driver info options ([#4654](https://github.com/RaschidJFR/node-mongodb-native/issues/4654)) ([b813c85](https://github.com/RaschidJFR/node-mongodb-native/commit/b813c85813c7c86b84aed1cdde69fc3e06856892))
* **NODE-7142:** Exponential backoff and jitter in retry loops ([#4871](https://github.com/RaschidJFR/node-mongodb-native/issues/4871)) ([22c6031](https://github.com/RaschidJFR/node-mongodb-native/commit/22c6031a673bef48597fb33041fe1122cc5ec549))
* **NODE-7150:** update peer dependency matrix for 3rd party peer deps ([#4720](https://github.com/RaschidJFR/node-mongodb-native/issues/4720)) ([0451dae](https://github.com/RaschidJFR/node-mongodb-native/commit/0451dae9df3eaf3a0f85ac6e783a1da6bb31d1d3))
* **NODE-7157:** deprecate `retryWrites` in `CommandOperationOptions` ([#4661](https://github.com/RaschidJFR/node-mongodb-native/issues/4661)) ([620972d](https://github.com/RaschidJFR/node-mongodb-native/commit/620972df28f57aae1eb67dd2d3a49f8cf48f7262))
* **NODE-7174:** drop support for Node16 and Node18 ([#4668](https://github.com/RaschidJFR/node-mongodb-native/issues/4668)) ([a576b7d](https://github.com/RaschidJFR/node-mongodb-native/commit/a576b7d3a8210f0544c3814b130ea21585ea1f9f))
* **NODE-7223:** run checkout on connect regardless of credentials ([#4715](https://github.com/RaschidJFR/node-mongodb-native/issues/4715)) ([c5f74ab](https://github.com/RaschidJFR/node-mongodb-native/commit/c5f74abe27acd8661f17046b1740ac74de1be082))
* **NODE-7259:** use alphas of all supporting packages ([#4746](https://github.com/RaschidJFR/node-mongodb-native/issues/4746)) ([e1ea14c](https://github.com/RaschidJFR/node-mongodb-native/commit/e1ea14ce80aece9d1cdd2e2c16ac1e5f4d9eff98))
* **NODE-7260:** update bson alpha to latest ([#4748](https://github.com/RaschidJFR/node-mongodb-native/issues/4748)) ([4e88559](https://github.com/RaschidJFR/node-mongodb-native/commit/4e88559e8785973dc2124a54d5e850a00616bb16))
* **NODE-7304:** remove usages in src of promisify ([#4799](https://github.com/RaschidJFR/node-mongodb-native/issues/4799)) ([761b9bf](https://github.com/RaschidJFR/node-mongodb-native/commit/761b9bfab8dfc8e3e7e311731d7a5cda1285bc6c))
* **NODE-7306:** Replace global process with import node:process ([#4820](https://github.com/RaschidJFR/node-mongodb-native/issues/4820)) ([cc503cb](https://github.com/RaschidJFR/node-mongodb-native/commit/cc503cb9810e2dbde0862fd8c8daa8ee613ef7b1))
* **NODE-7310:** Replace process.arch with os.arch() ([#4823](https://github.com/RaschidJFR/node-mongodb-native/issues/4823)) ([f0af829](https://github.com/RaschidJFR/node-mongodb-native/commit/f0af829f1a6fdf8cc0b070a327682f6299b747f1))
* **NODE-7311:** Replace process.platform with os.platform() ([#4822](https://github.com/RaschidJFR/node-mongodb-native/issues/4822)) ([c58ca1f](https://github.com/RaschidJFR/node-mongodb-native/commit/c58ca1f9d6a177470e58098ca1874174607c35c8))
* **NODE-7315:** Use BSON ByteUtils instead of Nodejs Buffer ([#4840](https://github.com/RaschidJFR/node-mongodb-native/issues/4840)) ([1add538](https://github.com/RaschidJFR/node-mongodb-native/commit/1add53872ea8e394959754375bf35af5632fbf0e))
* **NODE-7317:** use BSON.NumberUtils to determine endianness ([#4808](https://github.com/RaschidJFR/node-mongodb-native/issues/4808)) ([4e9467e](https://github.com/RaschidJFR/node-mongodb-native/commit/4e9467e8ab9ccbcf6eb47156d84ac538c5e3f6ea))
* **NODE-7319:** update allowed hosts list with *.mongo.com ([#4802](https://github.com/RaschidJFR/node-mongodb-native/issues/4802)) ([bfb7160](https://github.com/RaschidJFR/node-mongodb-native/commit/bfb71603fdfaaaebf418a3064f293d2c95697865))
* **NODE-7330:** deprecate RenameCollectionOptions.new_collection ([#4815](https://github.com/RaschidJFR/node-mongodb-native/issues/4815)) ([a96fa26](https://github.com/RaschidJFR/node-mongodb-native/commit/a96fa26dea3060828af747f0f2974229018de730))
* **NODE-7333:** add support for deprioritized servers to all topologies  ([#4821](https://github.com/RaschidJFR/node-mongodb-native/issues/4821)) ([a4211e7](https://github.com/RaschidJFR/node-mongodb-native/commit/a4211e77a30450ca8b162cbe3eec9f3759d3f517))
* **NODE-7335:** Create dedicated mocha runner with isolated vm context ([#4876](https://github.com/RaschidJFR/node-mongodb-native/issues/4876)) ([a4cba4c](https://github.com/RaschidJFR/node-mongodb-native/commit/a4cba4c86958198d17fe3a740b354e94fac37fc6))
* **NODE-7379:** Refactor Crypto to Web Crypto API ([#4862](https://github.com/RaschidJFR/node-mongodb-native/issues/4862)) ([ac98f4a](https://github.com/RaschidJFR/node-mongodb-native/commit/ac98f4a9beed60c9c16443482c354333ba86ea25))
* **NODE-7385:** add experimental `os` runtime adapter  ([#4851](https://github.com/RaschidJFR/node-mongodb-native/issues/4851)) ([d2ad07f](https://github.com/RaschidJFR/node-mongodb-native/commit/d2ad07f20903d86334da81222a6df9717f76faaa))
* **NODE-7441:** add `ChangeStream.bufferedCount` ([#4870](https://github.com/RaschidJFR/node-mongodb-native/issues/4870)) ([f7ea421](https://github.com/RaschidJFR/node-mongodb-native/commit/f7ea42191f866c3dd691ed8ac1ff428e72281483))
* **NODE-7452:** restrict server deprioritization on replica sets to overload errors ([#4875](https://github.com/RaschidJFR/node-mongodb-native/issues/4875)) ([87a3465](https://github.com/RaschidJFR/node-mongodb-native/commit/87a346536bc8528e67a8da4dfc96b4db289f80a9))
* **NODE-7467:** make token bucket optional in client backpressure ([#4878](https://github.com/RaschidJFR/node-mongodb-native/issues/4878)) ([4fb0a0a](https://github.com/RaschidJFR/node-mongodb-native/commit/4fb0a0abe84efdab9de82acbdb09609f4be0d2fb))
* **NODE-7491:** finalize client backpressure implementation for phase 1 rollout ([#4920](https://github.com/RaschidJFR/node-mongodb-native/issues/4920)) ([2cc7983](https://github.com/RaschidJFR/node-mongodb-native/commit/2cc7983e280bc946e7ecf8f7e29c7ac179f5eada))
* **NODE-7518:** bump maxWireVersion ([#4950](https://github.com/RaschidJFR/node-mongodb-native/issues/4950)) ([4447050](https://github.com/RaschidJFR/node-mongodb-native/commit/444705061ae49973a432fbcb0098419b72b75409))
* **NODE-7537:** promote QE string queries (prefix/suffix/substring) ([#4996](https://github.com/RaschidJFR/node-mongodb-native/issues/4996)) ([dc4900c](https://github.com/RaschidJFR/node-mongodb-native/commit/dc4900c36207d70b718c6fc013c5233ceb9f343c))
* **NODE-7634:** remove experimental tag from async dispose methods ([#4976](https://github.com/RaschidJFR/node-mongodb-native/issues/4976)) ([43ce3eb](https://github.com/RaschidJFR/node-mongodb-native/commit/43ce3ebb701bf24af797d24e81788b576dccf1a9))


### Bug Fixes

* **NODE-4763:** cache `resumeToken` in `ChangeStream.tryNext()` ([#4636](https://github.com/RaschidJFR/node-mongodb-native/issues/4636)) ([8331a93](https://github.com/RaschidJFR/node-mongodb-native/commit/8331a939c2f3d6833486ca3ec45cd77603cf3fa9))
* **NODE-4845:** allocate sessions lazily in cursors ([#4575](https://github.com/RaschidJFR/node-mongodb-native/issues/4575)) ([5761703](https://github.com/RaschidJFR/node-mongodb-native/commit/57617039c0275e25e607363fbdc971b0f94e99c7))
* **NODE-5225:** concurrent MongoClient.close() calls each attempt to close the client ([#4376](https://github.com/RaschidJFR/node-mongodb-native/issues/4376)) ([9419af7](https://github.com/RaschidJFR/node-mongodb-native/commit/9419af7b3bcbf134d0740c4282f83d1d5a717418))
* **NODE-6340:** OIDC reauth uses caches speculative auth result ([#4379](https://github.com/RaschidJFR/node-mongodb-native/issues/4379)) ([8b2b7fd](https://github.com/RaschidJFR/node-mongodb-native/commit/8b2b7fdc6366ee9b6b595daf074d6b88362df5e6))
* **NODE-6407:** use conversationId returned from server in saslContinue ([#4368](https://github.com/RaschidJFR/node-mongodb-native/issues/4368)) ([fbefa6b](https://github.com/RaschidJFR/node-mongodb-native/commit/fbefa6b6265bf3c5019e07626dd298c265ad4746))
* **NODE-6583:** upgrade to BSON v6.10.1 to remove internal unbounded type cache ([#4338](https://github.com/RaschidJFR/node-mongodb-native/issues/4338)) ([249c279](https://github.com/RaschidJFR/node-mongodb-native/commit/249c279ee21c0635ab22be10788ffcae52ad3bb5))
* **NODE-6589:** background task does not prune idle connections when minPoolSize=0 ([#4569](https://github.com/RaschidJFR/node-mongodb-native/issues/4569)) ([7cbb641](https://github.com/RaschidJFR/node-mongodb-native/commit/7cbb641f848993788f5d11812518d1e360df1d53))
* **NODE-6600:** set object mode correctly for message chunking in SizedMessageTransform ([#4345](https://github.com/RaschidJFR/node-mongodb-native/issues/4345)) ([5558573](https://github.com/RaschidJFR/node-mongodb-native/commit/555857319605d72ce57c639166ce25f57739bf74))
* **NODE-6602:** only wrap errors from SOCKS in network errors ([#4347](https://github.com/RaschidJFR/node-mongodb-native/issues/4347)) ([ed83f36](https://github.com/RaschidJFR/node-mongodb-native/commit/ed83f36ce17e40f0faf4bbaaeab6fa3b7f90b10a))
* **NODE-6613:** Update error messages when primaries go stale ([#4397](https://github.com/RaschidJFR/node-mongodb-native/issues/4397)) ([6528c8d](https://github.com/RaschidJFR/node-mongodb-native/commit/6528c8db3acfb28fa58a7cd587703d3d40c065aa))
* **NODE-6630:** read all messages in buffer when chunk arrives ([#4512](https://github.com/RaschidJFR/node-mongodb-native/issues/4512)) ([8c86e30](https://github.com/RaschidJFR/node-mongodb-native/commit/8c86e303594bad8c7b8cd9033fe47afe1e813388))
* **NODE-6638:** throw if all atomic updates are undefined ([#4519](https://github.com/RaschidJFR/node-mongodb-native/issues/4519)) ([9625b2d](https://github.com/RaschidJFR/node-mongodb-native/commit/9625b2d10a7d3548b423cf130fba89b383eeb8db))
* **NODE-6690:** Remove extraneous Document in replaceOne return type ([#4383](https://github.com/RaschidJFR/node-mongodb-native/issues/4383)) ([6c81d4e](https://github.com/RaschidJFR/node-mongodb-native/commit/6c81d4e839589dd51cea0dca10d4163a13744c94))
* **NODE-6763:** pass WriteConcernOptions instead on WriteConcernSettings ([#4421](https://github.com/RaschidJFR/node-mongodb-native/issues/4421)) ([26f15d7](https://github.com/RaschidJFR/node-mongodb-native/commit/26f15d7edc109154b1064299299158a8327a73da))
* **NODE-6765:** FindOneAndUpdateOptions supports aggregation expressions ([#4423](https://github.com/RaschidJFR/node-mongodb-native/issues/4423)) ([421ddeb](https://github.com/RaschidJFR/node-mongodb-native/commit/421ddeb329169f47b567cbe432c39737551bd234))
* **NODE-6777:** update BSON to 6.10.3 ([#4428](https://github.com/RaschidJFR/node-mongodb-native/issues/4428)) ([db5b9e0](https://github.com/RaschidJFR/node-mongodb-native/commit/db5b9e00c3966019fc79d7b275e585f07c59144c))
* **NODE-6792:** use isUint8Array from driver's utils instead of util/types ([#4436](https://github.com/RaschidJFR/node-mongodb-native/issues/4436)) ([dfe1fba](https://github.com/RaschidJFR/node-mongodb-native/commit/dfe1fba777d89a53106487e38aaf5072978096b5))
* **NODE-6794:** revert `@aws-sdk/credential-providers` peer compatibility change ([#4437](https://github.com/RaschidJFR/node-mongodb-native/issues/4437)) ([488c407](https://github.com/RaschidJFR/node-mongodb-native/commit/488c4071632c29960de8955bfbefbaab163b45ba))
* **NODE-6801:** set token on connection from cache ([#4438](https://github.com/RaschidJFR/node-mongodb-native/issues/4438)) ([cb13746](https://github.com/RaschidJFR/node-mongodb-native/commit/cb1374649858ae2e0f3f3e109d7bf7e4bcd193c2))
* **NODE-6803:** kms proxy socket creates unhandled rejection ([#4444](https://github.com/RaschidJFR/node-mongodb-native/issues/4444)) ([ed69cf9](https://github.com/RaschidJFR/node-mongodb-native/commit/ed69cf914435ebc96c44b265704571e3d34629ef))
* **NODE-6845:** ensure internal rejections are handled ([#4448](https://github.com/RaschidJFR/node-mongodb-native/issues/4448)) ([06e941a](https://github.com/RaschidJFR/node-mongodb-native/commit/06e941a87c5278d0a7baedccc646924bf64ddfb7))
* **NODE-6858:** treat MongoServerSelectionError as a resumable error for Change Streams ([#4653](https://github.com/RaschidJFR/node-mongodb-native/issues/4653)) ([c6d64e7](https://github.com/RaschidJFR/node-mongodb-native/commit/c6d64e71b010dbf2bc0dc634df12d7a03bd12da6))
* **NODE-6864:** socket errors are not always converted to MongoNetworkErrors ([#4473](https://github.com/RaschidJFR/node-mongodb-native/issues/4473)) ([2d86095](https://github.com/RaschidJFR/node-mongodb-native/commit/2d860953096e8f4e18896bef92843f1a0a3ccb04))
* **NODE-6878:** documents.clear() throws a TypeError after cursor is rewound ([#4488](https://github.com/RaschidJFR/node-mongodb-native/issues/4488)) ([a1fffeb](https://github.com/RaschidJFR/node-mongodb-native/commit/a1fffeb0e7fbd41832e6ae751a3f7369ea585b20))
* **NODE-6955:** add missing `wallTime` property TS change stream event interfaces ([#4541](https://github.com/RaschidJFR/node-mongodb-native/issues/4541)) ([f153c6f](https://github.com/RaschidJFR/node-mongodb-native/commit/f153c6f3df8c7c440af3bc0f862a30c53f9c5fc8))
* **NODE-6962:** OIDC machine workflows use OIDCCallbacks internally ([#4546](https://github.com/RaschidJFR/node-mongodb-native/issues/4546)) ([bd6030f](https://github.com/RaschidJFR/node-mongodb-native/commit/bd6030f2da079df0e36f011ead91e178647d6ac1))
* **NODE-7067:** Wrap socket write in a try/catch to ensure errors can be properly wrapped ([#4759](https://github.com/RaschidJFR/node-mongodb-native/issues/4759)) ([66c18b7](https://github.com/RaschidJFR/node-mongodb-native/commit/66c18b7ee948e43847b324b25b552c2ff9ca851c))
* **NODE-7138:** prevent duplicate metadata from being appended to handshake metadata ([#4651](https://github.com/RaschidJFR/node-mongodb-native/issues/4651)) ([05c230c](https://github.com/RaschidJFR/node-mongodb-native/commit/05c230cb1b0cc5831983ad2fc8f84200a35da63d))
* **NODE-7171:** capture resume token before resumeTokenChanged fires ([#4973](https://github.com/RaschidJFR/node-mongodb-native/issues/4973)) ([371579d](https://github.com/RaschidJFR/node-mongodb-native/commit/371579d45944a67dfa160090a543e1760aa60e2f))
* **NODE-7232:** only send endSessions during client close if the topology supports sessions ([#4722](https://github.com/RaschidJFR/node-mongodb-native/issues/4722)) ([cc85ebf](https://github.com/RaschidJFR/node-mongodb-native/commit/cc85ebf246b20e0bae59e1bdcdf0f9c74ea01979))
* **NODE-7247:** clarify #rewrapManyDataKey() parameter types ([#4760](https://github.com/RaschidJFR/node-mongodb-native/issues/4760)) ([cb522bf](https://github.com/RaschidJFR/node-mongodb-native/commit/cb522bfd0c45086a821e4918c0f1af33c68cfa7a))
* **NODE-7270:** remove extra BSONType file in docs/Next/variables ([#4754](https://github.com/RaschidJFR/node-mongodb-native/issues/4754)) ([df3aaaa](https://github.com/RaschidJFR/node-mongodb-native/commit/df3aaaa3480d19f82b4a0c265e4b9c4b6a69a94b))
* **NODE-7290:** use valueof for error code check ([#4791](https://github.com/RaschidJFR/node-mongodb-native/issues/4791)) ([1cc3d1c](https://github.com/RaschidJFR/node-mongodb-native/commit/1cc3d1c952274b2fc18ffd4898978af97f76b554))
* **NODE-7298:** ensure commonWireVersion is computed from server maxWireVersion ([#4805](https://github.com/RaschidJFR/node-mongodb-native/issues/4805)) ([2b2366d](https://github.com/RaschidJFR/node-mongodb-native/commit/2b2366dd18a76bd9e0b36b9911af6a0a317926c3))
* **NODE-7307:** Replace node:process.hrtime() with performance.now() ([#4816](https://github.com/RaschidJFR/node-mongodb-native/issues/4816)) ([ae2e037](https://github.com/RaschidJFR/node-mongodb-native/commit/ae2e037e896fbc673061da49a7c45743ae145651))
* **NODE-7308:** replace process.nextTick with queueMicrotask  ([#4817](https://github.com/RaschidJFR/node-mongodb-native/issues/4817)) ([b1b6e81](https://github.com/RaschidJFR/node-mongodb-native/commit/b1b6e81168a2cb6a2cc089d8c3cb83df1405931f))
* **NODE-7411:** iterate all servers on close ([#4967](https://github.com/RaschidJFR/node-mongodb-native/issues/4967)) ([72c0296](https://github.com/RaschidJFR/node-mongodb-native/commit/72c02969f49ebc239dd15ef3deaf9be15fbbb94f))
* **NODE-7430:** throw timeout error when `withTransaction` retries exceed deadline ([#4897](https://github.com/RaschidJFR/node-mongodb-native/issues/4897)) ([16a899d](https://github.com/RaschidJFR/node-mongodb-native/commit/16a899daa378a2c55aac75b1040159b5de8ee647))
* **NODE-7459:** explicitly call setKeepAlive and setNoDelay on socket ([#4879](https://github.com/RaschidJFR/node-mongodb-native/issues/4879)) ([778a2a1](https://github.com/RaschidJFR/node-mongodb-native/commit/778a2a141cd79f86113866c1051117715a6021cd))
* **NODE-7469:** overload retry when retryReads/Writes=false ([#4888](https://github.com/RaschidJFR/node-mongodb-native/issues/4888)) ([4157b26](https://github.com/RaschidJFR/node-mongodb-native/commit/4157b2600dda54ee14693ee951abd72e4da2b07e))
* **NODE-7478:** OIDC host allowlist fix ([#4905](https://github.com/RaschidJFR/node-mongodb-native/issues/4905)) ([f36b754](https://github.com/RaschidJFR/node-mongodb-native/commit/f36b7546e937d980cc7decb760eb8f561334fa6a))
* **NODE-7548:** SCRAM authentication fails on non-Node runtimes ([#4932](https://github.com/RaschidJFR/node-mongodb-native/issues/4932)) ([a10d2c9](https://github.com/RaschidJFR/node-mongodb-native/commit/a10d2c937eaa2bfb30aece513c9770ec55541280))
* **NODE-7549:** send afterClusterTime on writes in causally-consistent sessions ([#4963](https://github.com/RaschidJFR/node-mongodb-native/issues/4963)) ([3abfd26](https://github.com/RaschidJFR/node-mongodb-native/commit/3abfd263c5da2eaa5c223a0d5b9b440a1e1d4cf6))
* **NODE-7603:** emit dynamic `import('os')` via `tsconfig`  ([#4992](https://github.com/RaschidJFR/node-mongodb-native/issues/4992)) ([52f5e61](https://github.com/RaschidJFR/node-mongodb-native/commit/52f5e61c8a439f9284c82f72357c376783f055b4))


### Performance Improvements

* **NODE-6452:** Optimize CommandStartedEvent and CommandSucceededEvent constructors ([#4371](https://github.com/RaschidJFR/node-mongodb-native/issues/4371)) ([41b066b](https://github.com/RaschidJFR/node-mongodb-native/commit/41b066b2b286879085b05a58c0486aa1d24303bc))
* **NODE-6616:** shortcircuit logging ejson.stringify ([#4377](https://github.com/RaschidJFR/node-mongodb-native/issues/4377)) ([c1bcf0d](https://github.com/RaschidJFR/node-mongodb-native/commit/c1bcf0de991096975a5151bf780faa9803ddd765))
...
* **NODE-7537:** promote QE string queries (prefix/suffix/substring) ([#4996](https://github.com/mongodb/node-mongodb-native/issues/4996)) ([dc4900c](https://github.com/mongodb/node-mongodb-native/commit/dc4900c36207d70b718c6fc013c5233ceb9f343c))
